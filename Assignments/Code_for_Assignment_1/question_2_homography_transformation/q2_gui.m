function varargout = q2_gui(varargin)
% q2_gui MATLAB code for q2_gui.fig
%      q2_gui, by itself, creates a new q2_gui or raises the existing
%      singleton*.
%
%      H = q2_gui returns the handle to a new q2_gui or the handle to
%      the existing singleton*.
%
%      q2_gui('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in q2_gui.M with the given input arguments.
%
%      q2_gui('Property','Value',...) creates a new q2_gui or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before q2_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to q2_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help q2_gui
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @q2_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @q2_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before q2_gui is made visible.
function q2_gui_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = q2_gui_OutputFcn(hObject, eventdata, handles)
